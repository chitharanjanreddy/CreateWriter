    ...
    <div className="app-layout">
      <aside className="sidebar">
        <div className="sidebar-brand">
          ...
          <span className="brand-text">CreativeWriter</span>
        </div>
        ...
        <nav className="sidebar-nav">
          <div className="nav-section">
            ...
            <NavLink to="/lyrics" className="nav-item">
          ...
          {user?.role === 'admin' && (
            <div className="nav-section">
              ...
              <NavLink to="/admin/apikeys" className="nav-item">
        ...
        <div className="sidebar-footer">
          <div className="user-card">
            <div className="user-avatar">{user?.name?.split(' ').map(w => w[0]).join('').substring(0, 2).toUpperCase()}</div>
